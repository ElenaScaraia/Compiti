...
<main>
      <?php
        $prezzo_totale=0;
            $query="SELECT c.id AS id,id_prodotto,p.Nome AS nome_prodotto,p.quantita AS quantita,p.prezzo AS prezzo FROM carrelli c INNER JOIN prodotti p ON c.id_prodotto=p.id;";
